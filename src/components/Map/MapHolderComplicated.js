...
//                                    context.globalAlpha = 1;
                    ...
                    worldGround.queryElevation(
                        ...
                        self.routeRenderer.updateRoute(result.geometry.paths);
    ...
    componentDidUpdate(prevProps, prevState) {
       ...
       // if (this.props.currentCard) console.log(this.props.currentCard.id);
        ...
        /*if (this.esriLoaderContext && this.esriLoaderContext.worldGround && this.props.locations.length ) {
           // console.log(this.props.locations);
            if (this.props.locations.length) {
                ...
                this.esriLoaderContext.worldGround.queryElevation(
                    new that.esriLoaderContext.Polyline(polyline)
                ).then(result => {
                   // console.log(result.geometry.paths);
                    this.routeRenderer.updateRoute(result.geometry.paths[0]);
           ...
           /* if (this.props.card.camera && this.props.card.camera.stop && that.esriLoaderContext) {
            ...
            if (this.props.card.camera && this.props.card.camera.start && that.esriLoaderContext) {
                this.routeRenderer.start();
            }*/
        ...
        if (this.props.currentCard !== this.state.currentCard && that.esriLoaderContext) {
           // console.log(that.esriLoaderContext.view.camera.position.toJSON());
           // this.state.currentCard.camera && console.log(this.state.currentCard.camera.position)
        }
        ...
        if (this.props.currentCard !== this.state.currentCard && that.esriLoaderContext) {
            ...
            //maybe set this once card camera progression is complete
           ...
           // s alert(1);
            ...
            if (this.props.currentCard && this.props.currentCard.camera) {
                ...
                that.esriLoaderContext.view.goTo(this.props.currentCard.camera, { duration: 1600}).then(()=> {
