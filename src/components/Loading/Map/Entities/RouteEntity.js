...
export default class RouteEntity extends THREE.Group {
  ...
  updateRoute(path, externalRenderers, view, SpatialReference)
  {
    ...
    //lat longs
    const curve_path = [];
    const simplificationTolerance = 0.00001;
    ...
    var extrudeSettings = {
      ...
      bevelEnabled: true, // this be always false in ExtrudeBufferGeometryWithLength
      extrudePath: curve,
    };

    const squareShape = new THREE.Shape();
    squareShape.moveTo(0, -40);
    squareShape.lineTo(0, 30);
    squareShape.lineTo(184, 30);
    squareShape.lineTo(184, 0);
